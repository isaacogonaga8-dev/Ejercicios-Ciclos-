...
## Código en Java
El código fuente completo se encuentra en el archivo [`CalificacionesControl.java`](./CalificacionesControl.java).
...
2. Asegurarse de tener instalado el **JDK (Java Development Kit)** versión 8 o superior.
3. Abrir una terminal en la carpeta donde se encuentra el archivo `CalificacionesControl.java`.
4. Compilar el programa:
   ```bash
   javac CalificacionesControl.java
   ```
5. Ejecutar el programa:
   ```bash
   java CalificacionesControl
   ```
6. Ingresar el número de estudiantes (N) y, a continuación, la calificación de cada uno cuando el programa lo solicite.
...
> 📷 Incluir en esta sección las capturas de pantalla de la ejecución del programa en consola, mostrando al menos:
> - La validación de N inválido y su corrección.
> - La validación de una calificación fuera de rango y su corrección.
> - La salida final de resultados para el caso límite (notas 0, 7 y 10).
